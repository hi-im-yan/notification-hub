...
@Service
public class PushBulletScheduleNotificationRepository implements NotificationRepository {

    private final PushBulletScheduleNotificationMongoRepository mongoRepository;

    @Override
    public Notification persist(Notification notification) {
        var data = NotificationMapper.toPushBulletData(notification);
    ...
    public void delete(Notification notification) {
        var toDelete = NotificationMapper.toPushBulletData(notification);
